    ...
    <div class="container4">
    	...
    	<div class="c4_b1">
        	<ul class="c4_b1_boxes">
            	<c:forEach items="${listBook}" var="lsb">
            		<li>
                	<img src="images/hot_1.png">
	                    <div class="c4_b1_box_txt">
	                    	<p>${lsb.name}</p>
	                        <h1>活动价：<b>￥${lsb.price}</b></h1>
        ...
        <div class="c4_b2">
            ...
            <ul class="c4_b2_y">
                ...
                <li>
                    ...
                    <span class="search_val">${parentCategory.publisher}</span>
                    <span class="search_del"></span>
                </li>
            </ul>
        </div>
        ...
        <div class="c4_b5">
        	<div class="c4_b5_content">
            	<ul class="c4_b5_c_boxes">
                   <c:forEach items="${listBook}" var="lsbk">
                    <li class="c4_b5_c_box">
                        ...
                        <div class="c4_b5_c_box_txt">
                        	<h1>￥ ${lsbk.price}</h1>
                            <h2><a href="viewBook.html">${lsbk.name}</a></h2>
                        </div>
                        <!--购买等操作-->
                        <div class="c4b5_el">
                        	<div class="c4b5_el_x">
