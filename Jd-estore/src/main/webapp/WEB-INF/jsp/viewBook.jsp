    	...
    	<div class="top_center">
            <ul class="top_bars">
            	<c:if test="${empty customer}">
            		<li><a href=doIndexServlet>登录</a></li>
            		<li><a href="toRegisterServlet">注册</a></li>
            	</c:if>
            	<c:if test="${not empty customer}">
	            	<li><a href="goBack">退出</a>|</li>
	...
	<div class="container5">
    	<div class="cn5_top">
            <div class="cn5_top_x center01">
                ...
                <a href="#">${viewBookMessage.description}</a>
            </div>
            <div class="cn5_top_y center01">
                ...
                <div class="cn5topy_2">
                	<h1 class="pro_title font15">${viewBookMessage.name}</h1>
                    <div class="pro_price">
                            <div class="pro_price_x">
                                <p> briup价：<b>${viewBookMessage.price}</b> <a href="#">(降价通知)</a></p>
                            </div>
                    ...
                    <div class="pro_selects">
                        ...
                        <div class="pro_select">
                            ...
                            <ul class="pro_select_vals">
                                <li> ${viewBookMessage.publisher}</li>
                        ...
                        <div class="pro_select">
                            ...
                            <ul class="pro_select_vals">
                                <li> 出版时间：${viewBookMessage.pubdate}</li>
                                <li>包装：平装</li>
                                <li>正文语种：中文</li>
                            </ul>
                        </div>
				...
				<input type="hidden" name="id" value="${viewBookMessage.id}">
                    <div class="pro_buy">
                       ...
                       <div class="pro_addshop" onclick="submitForm()">加入购物车</div> 
                         <!-- <div class="pro_addshop"><a href="addShopCarServlet">加入购物车</a></div> -->
                    </div>
				</form>
                    <div class="pro_ship">
                        <div>
